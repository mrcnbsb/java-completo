...
public class Post implements Serializable {
    ...
    @Id //Id é uma anotação do Spring Data MongoDB que indica que o campo id é o identificador do documento no MongoDB. Ele será mapeado para o campo "_id" do documento.
    private String id;
    private Date date;
